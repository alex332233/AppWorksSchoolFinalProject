...
contract UniswapV3FlashSwap {
    ...
    function flashSwap(
        ...
        IUniswapV3Pool pool = IUniswapV3Pool(pool0);

        (uint128 fee0, uint128 fee1) = pool.protocolFees();
        // uint24 feePercentage = fee1 / 2 ** 24;

        console.log("Pool fee0 tier: ", fee0);
        console.log("Pool fee1 tier: ", fee1);
    ...
    function uniswapV3SwapCallback(
        ...
        // swap token on UniswapV3 pool
        // pool selected by router
