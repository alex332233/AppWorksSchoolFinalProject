...
import "../src/UniswapV2FlashSwap_Ex.sol";
...
contract UniswapV2FlashSwapTest is Test {
    ...
    function testFlashSwap() public {
        ...
        console.log("amountToRepay: ", uni.amountToRepay());
        assertGt(uni.amountToRepay(), amountToBorrow);
    }
}

// forge test -vv --gas-report --fork-url $FORK_URL --match-path test/UniswapV2FlashSwap_Ex.t.sol
